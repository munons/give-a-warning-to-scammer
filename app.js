...
async function main() {
  try {
    const urls = fs
      ...
      .trim()
      .split('\n');
    const customText = 'JANGANLAH KAU BERSENANG-SENANG ATAS ILMU YG KAU MILIKI TAPI TIDAK ADA KEMANFAATANNYA DAN SEBALIKNYA MERUGIKAN ORANG LAIN, INGAT KARMA MENANTI KARENA BANYAK ORANG BERSUMPAH KEBURUKAN KEPADAMU!!!'; // Custom text
